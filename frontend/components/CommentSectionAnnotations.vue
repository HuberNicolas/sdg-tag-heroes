<template>
  <div>
    <div class="frame-title"><b>Interact</b> with Community Comments</div>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-4 p-4 border rounded-md shadow-sm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 w-full md:w-auto">
        ...
        <div class="flex flex-wrap items-center gap-x-2">
          ...
          <select id="sort" v-model="sortBy" class="p-2 border rounded w-auto" @change="sortAnnotations">
...
const sortedAnnotations = computed(() => {
  return [...labelDecisionsStore.annotations].sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
});
